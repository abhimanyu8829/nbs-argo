{{- define "auth-worker.name" -}}
{{- default .Chart.Name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "auth-worker.fullname" -}}
{{- if .Values.fullnameOverride -}}
{{- .Values.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- include "auth-worker.name" . -}}
{{- end -}}
{{- end -}}

{{- define "auth-worker.labels" -}}
app: {{ include "auth-worker.fullname" . }}
managed-by: {{ .Values.labels.managedBy | quote }}
app.kubernetes.io/name: {{ include "auth-worker.name" . }}
...
{{- define "auth-worker.selectorLabels" -}}
app: {{ include "auth-worker.fullname" . }}
app.kubernetes.io/name: {{ include "auth-worker.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end -}}

{{- define "auth-worker.databaseUrl" -}}
