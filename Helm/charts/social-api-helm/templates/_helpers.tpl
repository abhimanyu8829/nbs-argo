{{- define "social-api.name" -}}
{{- default .Chart.Name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "social-api.fullname" -}}
{{- if .Values.fullnameOverride -}}
{{- .Values.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- include "social-api.name" . -}}
{{- end -}}
{{- end -}}

{{- define "social-api.labels" -}}
app: {{ include "social-api.fullname" . }}
managed-by: {{ .Values.labels.managedBy | quote }}
app.kubernetes.io/name: {{ include "social-api.name" . }}
...
{{- define "social-api.selectorLabels" -}}
app: {{ include "social-api.fullname" . }}
app.kubernetes.io/name: {{ include "social-api.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end -}}

{{- define "social-api.databaseUrl" -}}
